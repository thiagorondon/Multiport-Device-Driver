...
#define SB105X_GET_CHAR(info)	inb((info)->port + SB105X_RX)
#define SB105X_GET_IER(info)	inb((info)->port + SB105X_IER)
#define SB105X_GET_ISR(info)	inb((info)->port + SB105X_ISR)
#define SB105X_GET_LCR(info)	inb((info)->port + SB105X_LCR)
#define SB105X_GET_MCR(info)	inb((info)->port + SB105X_MCR)
#define SB105X_GET_LSR(info)	inb((info)->port + SB105X_LSR)
#define SB105X_GET_MSR(info)	inb((info)->port + SB105X_MSR)
#define SB105X_GET_SPR(info)	inb((info)->port + SB105X_SPR)

#define SB105X_PUT_CHAR(info,v)	outb((v),(info)->port + SB105X_TX )
#define SB105X_PUT_IER(info,v)	outb((v),(info)->port + SB105X_IER )
#define SB105X_PUT_FCR(info,v)	outb((v),(info)->port + SB105X_FCR )
#define SB105X_PUT_LCR(info,v)	outb((v),(info)->port + SB105X_LCR )
#define SB105X_PUT_MCR(info,v)	outb((v),(info)->port + SB105X_MCR )
#define SB105X_PUT_SPR(info,v)	outb((v),(info)->port + SB105X_SPR )


/* page 1 */
#define SB105X_GET_REG(info,reg)	inb((info)->port + (reg))
#define SB105X_PUT_REG(info,reg,v)	outb((v),(info)->port + (reg))

/* page 2 */

#define SB105X_PUT_PSR(info,v)	outb((v),(info)->port + SB105X_PSR )
